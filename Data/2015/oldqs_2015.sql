...
--
-- Host: localhost:8889
-- Generation Time: Feb 26, 2016 at 07:35 PM
...
(11, 'If a class B network on the Internet has a subnet mask of 255.255.248.0, what is the maximum number of hosts per subnet?', '1022', '1024', '2046', '2048', 'C', 1, 10),
...
(16, 'Which of these is a learner that can be used to solve classification problems?', 'Logistic regression', 'Linear regression', 'Polynomial regression', 'Non-parametric regression', 'A', 0, 10),
